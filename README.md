...
In this section, we'll be building a featureExtractor, mapping tweets to a discrete sized array (a bag of words model), training a Perceptron and evaluating our results. The relevant python skeleton and solution are listed bellow.

- [model.py](model.py)
- [model_solution.py](model_solution.py)


# 2: Analysis and Feature Engineering
In this section, we'll talk about a simple example of [underfitting and overfitting](http://scikit-learn.org/stable/auto_examples/model_selection/plot_underfitting_overfitting.html). First we'll talk about learning curves, and how to get and intuition of what your learning algorithm is doing and how we can address each of those problems with our features. As before, the relevant skeleton and solution are listed below.

- [featureEngineering.py](featureEngineering.py)
- [featureEngineering_solution.py](featureEngineering_solution.py)


# 3: Exploring more classifiers
Scikit-learn makes it really easy to experiment with different types of classifiers. In this section, we'll show how we can switch from the previous implemention of *model.py* with Perceptron to a Passive Agressive Classifier, or an SVM. The relevant skeleton and solution are called:

- [allModels.py](allModels.py)
- [allModels_solution.py](allModels_solution.py)
